...
The underlying ANOVA data set in Excel format here. The analysis is conducted using the open source programming language R - see <https://cran.r-project.org/> for full details. 

 [here](https://github.com/sede-open/naf_study/blob/main/ANOVA_Raw%20Data.xlsx) 
