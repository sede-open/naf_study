---
title: 'National Attentuation Factors Analysis Report'
output:
...
```{r inputData, include=TRUE,echo=T}
...
for(i in SignifVars){
  ...
  plot(predictorEffects(predictor=i,mod=lmSignif), axes=list(grid=TRUE,
                                       ...
                                       x=list(rotate=45,cex=0.75)),
       lines=list(lty=0),ylim=c(-4.5,-2))
